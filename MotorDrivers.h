...
// CARL CHANGED THIS
//(byte power_pin, byte signal_pin, byte signal_pin2, int8_t brake_pin, 
  //byte current_pin, float senseFactor, unsigned int tripMilliamps, byte faultPin
#define IBT_2_WITH_ARDUINO F("IBT_2_WITH_ARDUINO_SHIELD"),                                              \
                         new MotorDriver(4,   5,  6, UNUSED_PIN, A5, 10, 1000, UNUSED_PIN), \
                         new MotorDriver(11, 12, 13, UNUSED_PIN, A4, 10, 1000, UNUSED_PIN)
//#define IBT_2_WITH_ARDUINO F("IBT_2_WITH_ARDUINO_SHIELD"),                                              \
